...
fun KIMIPackage.installUIFont() {
    ...
    exporter.exportProperty(UIFont::class.java, "pointSize")
    exporter.exportProperty(UIFont::class.java, "fontStyle")
    exporter.exportProperty(UIFont::class.java, "fontName")
